    ...
    <form id="fm" method="post">
        <table cellspacing="8px">
            ...
            <tr>
                <td>角色：</td>
                <td>
                    <input id="roleIds" name="roleIds" class="easyui-combobox" name="dept" valueField="id" textField="text"
                           url="${ctx}/role/queryAllRoles" panelHeight="auto" editable="false" multiple="true"/>
                </td>
            </tr>
